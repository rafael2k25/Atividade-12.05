...
namespace ATV.Controllers
{
    ...
    public class ClienteController : ControllerBase
    {
        ...
        {
            var usuarioCookie = Request.Cookies["IdLogado"];
        ...
        public IActionResult login(Cliente cliente)
        {
            ...
            HttpContext.Session.SetString("IdLogado", clientes[0].Id.ToString());
            Response.Cookies.Append("IdLogado", clientes[0].Id.ToString(),
                new CookieOptions
                {
                    HttpOnly = true,
                    Secure = true,
